...
function draw() {
    ...
    bombs.forEach(b => {
        ...
        // Flashes quickly based on frame intervals
...
function spawnItem(type) {
    ...
    // FIXED: Set fuse to 30 frames (~500 milliseconds / half a second delay)
    if(type==='bomb') bombs.push({x:rx, y:ry, ignited: false, fuse: 30});
